...
class Htdw4438V2Cfg(LeggedRobotCfg):
    # ==========================
    # 1. 环境与地形 (适配 HimLoco)
    # ==========================
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/htdw_4438V2/urdf/htdw_4438.urdf'
        name = "htdw_4438_v2"
        foot_name = "foot"
...
# 训练参数 (PPO Runner)
# ==========================
class Htdw4438V2CfgPPO(LeggedRobotCfgPPO):
    class algorithm(LeggedRobotCfgPPO.algorithm):
        entropy_coef = 0.01
        learning_rate = 1e-3 # 降低一点学习率

    class runner(LeggedRobotCfgPPO.runner):
        run_name = 'htdw_4438_v2_himloco_v1.0'
        experiment_name = 'flat_htdw_4438_v2'
