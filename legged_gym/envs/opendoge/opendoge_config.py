...
class OpendogeCfg(LeggedRobotCfg):
    # ==========================
    # 1. 环境与地形 (适配 HimLoco)
    # ==========================
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = {
            'FL_hip_joint': 0.0,  'FL_thigh_joint': 0.6, 'FL_calf_joint': -1.5,
            'FR_hip_joint': 0.0,  'FR_thigh_joint': 0.6, 'FR_calf_joint': -1.5,
            'RL_hip_joint': 0.0,  'RL_thigh_joint': 0.6, 'RL_calf_joint': -1.5,
            'RR_hip_joint': 0.0,  'RR_thigh_joint': 0.6, 'RR_calf_joint': -1.5,
        }
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/Opendoge/urdf/Opendoge.urdf'
        name = "opendoge"
        foot_name = "foot"
