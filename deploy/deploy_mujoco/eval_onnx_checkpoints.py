...
DEFAULT_YAML_PATH = os.path.join(SCRIPT_DIR, "configs", "htdw_4438.yaml")
DEFAULT_XML_PATH = os.path.join(PROJECT_ROOT, "resources", "robots", "htdw_4438", "xml", "scene.xml")
DEFAULT_ONNX_GLOB = os.path.join(PROJECT_ROOT, "onnx", "*.onnx")
