...
YAML_PATH = os.path.join(SCRIPT_DIR, "configs", "htdw_4438_v2.yaml")
XML_PATH = os.path.join(PROJECT_ROOT, "resources", "robots", "htdw_4438V2", "xml", "scene.xml")


def parse_args():
    parser = argparse.ArgumentParser(description="Deploy HTDW4438-v2 policy in MuJoCo.")
...
ONNX_PATH = resolve_onnx_path(
    ...
    cli_onnx=ARGS.onnx,
    env_vars=["HTDW_V2_ONNX_PATH", "HTDW_ONNX_PATH"],
    onnx_glob="flat_htdw_4438_v2*.onnx",
    robot_name="htdw_4438_v2",
)
